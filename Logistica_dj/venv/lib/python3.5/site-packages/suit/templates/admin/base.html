...
{% block title %}{{ title }} | {{ site_title|default:_('Logistica MTE - CTEP') }}{% endblock %}

{% block branding %}
    <h1 id="site-name">
        <a href="{% url 'admin:index' %}">
            {{ site_header|default:_('Logística MTE - CTEP') }}
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-3 text-sm-right footer-version">
                            {% block footer_branding %}
                                {% with admin_name=site_header|default:_('Logística MTE - CTEP') django_version='django_version'|suit_conf:request %}
                                    {{ admin_name }}
